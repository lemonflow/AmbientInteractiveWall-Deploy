...
var Background = (function () {
    ...
    Background.prototype.init = function(scene) {
        ...
        var light = new FSS.Light('#222233', '#6c6c6c');
        var geometry = new FSS.Plane(1280, 800, 2, 2);
        ...
        function animate() {
            now = Date.now() - start;
            light.setPosition((clientid%2==0?1:-1)*300*Math.sin(now*0.001), 200*Math.cos(now*0.0005), 60);
